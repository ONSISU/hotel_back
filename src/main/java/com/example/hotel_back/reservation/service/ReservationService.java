...
import com.example.hotel_back.reservation.mapper.ReservationMapper;
...
//		}
	...
	public List<OwnHotelDTO> getAvailableRooms(AvailableRoomRequest request) {
		return reservationMapper.getAvailableRooms(request);
	}
}
